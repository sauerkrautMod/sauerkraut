...
public final class ModBlocks {
    ...
    private static final Item.Properties BLOCKITEM_PROPS_DEFAULT = new Item.Properties().group(ModItemGroups.MOD_ITEM_GROUP);

    // Ore BlockItems
    public static final RegistryObject<Item> ITEM_COPPER_ORE = ITEMS.register("copper_ore", BLOCK_COPPER_ORE.lazyMap(block -> new BlockItem(block, BLOCKITEM_PROPS_DEFAULT)));

    // Plant BlockItems
    public static final RegistryObject<Item> ITEM_POINTY_CABBAGE_BLOCK = ITEMS.register("pointy_cabbage_block", BLOCK_POINTY_CABBAGE.lazyMap(block -> new BlockItem(block, BLOCKITEM_PROPS_DEFAULT)));
}
